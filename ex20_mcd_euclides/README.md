...
# Ejercicio 20 — Máximo Común Divisor (Euclides) — (GitHub Classroom + IA)

## Contexto (por qué importa)
Sincronización de razones (engranes, frecuencias, lotes).

## Enunciado del problema
Lee dos enteros positivos `a` y `b`. Si alguno es ≤ 0, imprime `Invalid input`. Si ambos > 0, calcula el **MCD(a,b)** con Euclides (while) y **muestra el resultado**.
