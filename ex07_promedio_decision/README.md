...
# Ejercicio 07 — Promedio con decisión (GitHub Classroom + IA)

## Contexto (por qué importa)
Promediar mediciones cuando la cantidad no se conoce de antemano.

## Enunciado del problema
Lee flotantes hasta que aparezca un **negativo**. Calcula el **promedio** de los valores **>= 0**.
