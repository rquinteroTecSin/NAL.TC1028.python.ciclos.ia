...
# Ejercicio 13 — Pares dentro de un rango (GitHub Classroom + IA)

## Contexto (por qué importa)
Filtrado de valores discretos (p.ej., muestreos cada 2 unidades en un intervalo).

## Enunciado del problema
Lee dos enteros `a` y `b` (orden libre). Imprime todos los **pares** del rango **[min(a,b), max(a,b)]**.  
Si **no hay pares**, imprime `No hay pares`.
