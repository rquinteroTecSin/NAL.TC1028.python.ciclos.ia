...
# Ejercicio 06 — Cantidad de pares hasta negativo (GitHub Classroom + IA)

## Contexto (por qué importa)
Conteos con señal de corte.

## Enunciado del problema
Lee enteros hasta un **negativo**. Cuenta cuántos fueron **pares** (incluye 0). Imprime `Total de pares=<k>`.
