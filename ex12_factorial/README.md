...
# Ejercicio 12 — Factorial iterativo (GitHub Classroom + IA)

## Contexto (por qué importa)
Conteos combinatorios y crecimiento factorial en estimaciones de complejidad y probabilidad.

## Enunciado del problema
Lee un entero `n`. Si `n<0`, imprime exactamente `Factorial no definido para negativos`. En caso contrario, imprime `n!`.
