...
# Ejercicio 11 — Menor k con k^2 > N (GitHub Classroom + IA)

## Contexto (por qué importa)
Dimensionado preliminar: encontrar el **mínimo tamaño/valor** que supera un umbral (capacidad, potencia, sección).

## Enunciado del problema
Lee un entero `N` y calcula el **menor entero `k`** tal que `k*k > N`. Imprime `k`.
