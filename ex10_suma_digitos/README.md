...
# Ejercicio 10 — Suma de dígitos (GitHub Classroom + IA)

## Contexto (por qué importa)
Chequeo simple sobre identificadores.

## Enunciado del problema
Lee un entero (positivo o negativo). Muestra la **suma de sus dígitos** (resultado no negativo).
