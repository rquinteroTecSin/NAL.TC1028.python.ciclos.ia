...
# Ejercicio 09 — Alterna caracteres (# y %) (GitHub Classroom + IA)

## Contexto (por qué importa)
Simular una **señal alternante** de dos estados.

## Enunciado del problema
Lee `n`. Imprime `n` líneas con el formato `i-<caracter>`, comenzando en `1-#` y alternando con `%`.
