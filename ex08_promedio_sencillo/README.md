...
# Ejercicio 08 — Promedio sencillo con n (GitHub Classroom + IA)

## Contexto (por qué importa)
Cuando `n` es conocido, primero se captura `n` y luego se promedian las lecturas.

## Enunciado del problema
Lee `n`, luego `n` flotantes. Muestra el **promedio**.
