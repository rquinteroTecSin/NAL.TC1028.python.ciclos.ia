...
# Ejercicio 15 — Interés compuesto mensual (12 meses) (GitHub Classroom + IA)

## Contexto (por qué importa)
Crecimiento de inversiones con capitalización mensual.

## Enunciado del problema
Lee el saldo inicial (float) y el **porcentaje anual** (float).  
Si alguno es negativo, imprime `Error en los datos`.  
Si son válidos, capitaliza **mensualmente** por 12 meses y muestra el saldo final con **dos decimales**.
