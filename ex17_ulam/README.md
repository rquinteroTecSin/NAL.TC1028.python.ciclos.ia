...
# Ejercicio 17 — Conjetura de Ulam (Collatz) (GitHub Classroom + IA)

## Contexto (por qué importa)
Secuencias iterativas con reglas según paridad; útil para pensar invariantes.

## Enunciado del problema
Lee un entero `n` > 0. Si `n <= 0`, imprime `Invalid input`.  
Si es válido, imprime en **una sola línea** la secuencia Collatz desde `n` hasta `1`, separada por **espacios**.
