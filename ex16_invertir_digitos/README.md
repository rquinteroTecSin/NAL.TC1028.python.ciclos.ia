...
# Ejercicio 16 — Invertir dígitos (hasta 6) (GitHub Classroom + IA)

## Contexto (por qué importa)
Transformaciones numéricas preservando el signo.

## Enunciado del problema
Lee un entero (positivo o negativo). Si su valor absoluto tiene **más de 6 dígitos**, imprime `Too long`.  
En caso contrario, imprime el número con **dígitos invertidos** (conservando el signo).
