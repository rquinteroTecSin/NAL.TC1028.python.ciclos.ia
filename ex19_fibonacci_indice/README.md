...
# Ejercicio 19 — Número de Fibonacci por índice (GitHub Classroom + IA)

## Contexto (por qué importa)
Modelado de procesos recursivos con solución iterativa eficiente.

## Enunciado del problema
Lee un entero `idx` ≥ 0 y muestra el número de Fibonacci en esa posición (serie `0,1,1,2,3,...`).  
Usa un **ciclo `while`** y conserva solo los dos últimos valores.
